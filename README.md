...
│  ├── UI/UX minimalista                          │
│  ├── HTML5 semántico                            │
│  └── CSS custom para estilos únicos             │
│                                                  │
│  🎯 Objetivo: Dominar fundamentos frontend      │
│  📚 Aprender: HTML, CSS, Bootstrap, diseño      │
└─────────────────────────────────────────────────┘

┌─────────────────────────────────────────────────┐
│  FUTURO LEJANO: Backend + Database              │
│  (Cuando domine completamente el frontend)      │
│                                                  │
...
| Bootstrap | 5.3 | Framework UI y grid system |

> 💡 **Nota:** Este proyecto se centra 100% en frontend para dominar los fundamentos antes de avanzar a tecnologías backend.

### Futuro Stack (Cuando esté listo)

El backend y base de datos se implementarán cuando se dominen completamente:
- HTML5 y CSS3
- Bootstrap y diseño responsive# 🧢 SOMOS IDENTIDAD
...
- [ ] Buscador (UI)
- [ ] Detalle de producto
- [ ] Carrito de compras (UI estática)
- [ ] Formulario de contacto (UI)

### 🎯 Enfoque Actual

Todo el desarrollo está centrado en:
- **UI/UX profesional** con Bootstrap
- **Componentes reutilizables** y modulares
- **Diseño responsive** mobile-first
- **Código limpio** y bien estructurado
- **Sin JavaScript** por ahora (solo HTML + CSS)

### 🔮 Futuro Lejano

Cuando se domine el frontend, se considerará:
- Funcionalidad dinámica con JavaScript
- Gestión de inventario con backend
...
**Fase actual:** Aprendiendo y construyendo componentes base
**Enfoque:** Dominar HTML, CSS y Bootstrap antes de avanzar
